    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
      ...
      <div className="pulse-card p-6 flex flex-col justify-between">
        ...
        <div className="mt-4 mb-3">
          <span className="text-3xl font-bold text-white">{executionRatio.value}</span>
        </div>
      ...
      <div className="pulse-card p-6 flex flex-col justify-between">
        ...
        <div className="mt-4 mb-2">
          <span className="text-3xl font-bold text-white">{tradeVolume.value}</span>
        </div>
      ...
      <div className="pulse-card p-6 flex flex-col justify-between">
        ...
        <div className="mt-4 mb-2">
          <span className="text-3xl font-bold text-white">{activeMargin.value}</span>
        </div>
